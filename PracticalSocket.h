...
#ifndef PROJECT_PRACTICALSOCKET_H
#define PROJECT_PRACTICALSOCKET_H
...
public:
    ...
    /**
     *  Provide access to the socket descriptor
     */
    int getsockDesc ();
...
#endif //PROJECT_PRACTICALSOCKET_H
